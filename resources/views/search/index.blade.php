...
<section class="px-4 sm:px-6 lg:px-8">
    <form action="{{ route('search') }}" method="GET" class="mb-10">
        <input 
            ...
            value="{{ $query }}" 
            class="w-full bg-[#161D2F] text-white placeholder-gray-400 px-6 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FC4747]"
        />
    </form>
    ...
    @elseif($results->isNotEmpty())
        <h2 class="text-xl mb-6">Results for "{{ $query }}"</h2>
